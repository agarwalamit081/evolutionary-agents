...
async def self_inspect(module_path: str = "", max_lines: int = 100) -> str:
    ...
    Args:
        module_path: Relative path within the src package (e.g., "graph/nodes/execute.py").
        max_lines: Maximum lines to return.

    Returns:
        Source code contents.
    """
    # Determine the src package root
...
TOOL_DEFINITION = {
    ...
    "parameters": {
        ...
        "properties": {
            "module_path": {
                "type": "string",
                "description": "Relative path within the src package (e.g., 'graph/nodes/execute.py').",
                "default": "",
            },
            "max_lines": {
                "type": "integer",
