"""Built-in tools package — 23 distinct tools for the agent.
...
from src.tools.builtin.lean4_runner import TOOL_DEFINITION as LEAN4_RUNNER_DEF
...
TOOL_ANNOTATIONS: dict[str, dict[str, object]] = {
    ...
    "lean4_runner": {"tags": ["formal", "compute"], "mcp_hints": {"openWorldHint": True}},
