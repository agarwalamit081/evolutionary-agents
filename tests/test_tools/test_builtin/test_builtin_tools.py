...
class TestToolDefinitions:
    ...
    def test_twenty_two_tools_registered(self) -> None:
        """Exactly 22 built-in tools are registered (14 audited + arxiv_search + 2 corpus tools + ocr_parser + image_generator + create_scheduled_task + git_clone + code_search)."""
